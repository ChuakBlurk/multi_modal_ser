...
def read_data(datasetPATH):
    ...
    for ses in range(1,4):
        ...
        extractionmapPATH = datasetPATH+'extractionmap/cut_extractionmap'+str(ses)+'.xlsx'
        xl = pd.ExcelFile(extractionmapPATH)
        sessionPATH = datasetPATH+'face/Session'+str(ses)+'/'
        ...
        for vid in videos:
            ...
            if vid != '.DS_Store' and vid != 'Thumbs.db':
                ...
                audioPATH = datasetPATH+'spectogram/Session'+str(ses)+'/'+sheet+'.wav/'
...
def main():
    ...
    data = read_data('E:/datasets/preprocessed/')
    ...
    df1.to_csv('E:/datasets/preprocessed/training_data.csv')
    df2.to_csv('E:/datasets/preprocessed/evaluation_data.csv')
    df3.to_csv('E:/datasets/preprocessed/prediction_data.csv')
